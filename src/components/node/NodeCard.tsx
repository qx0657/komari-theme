  ...
  return (
    <header className="server-card-header">
      <div className="server-card-title-block">
        ...
        {(subtitle || node.ipv4 || node.ipv6 || ipBadges.length > 0 || offlineDuration) && (
          <div className="server-card-subtitle-row">
            ...
            <IpStackBadges ipv4={node.ipv4} ipv6={node.ipv6} extra={ipBadges} />
            {offlineDuration && (
      ...
      <div className="server-card-actions">
        <NodeHideButton uuid={node.uuid} name={node.name} />
        <NodeCopyIpPopover ipv4={node.ipv4} ipv6={node.ipv6} />

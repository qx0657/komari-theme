      ...
      <div className="node-list-cell node-list-node">
        <div className="node-list-node-text">
          <div className="node-list-node-head">
            ...
            <NodeHideButton uuid={node.uuid} name={node.name} size={14} />
          </div>
          {(renewalPrice || footerTags.length > 0 || node.ipv4 || node.ipv6 || ipBadges.length > 0) && (

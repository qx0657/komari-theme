...
const IspUsage = lazy(() =>
  import("@/pages/IspUsage").then((module) => ({ default: module.IspUsage })),
);

function IspUsageGate() {
  const themeSettings = useThemeSettings();
  const ispQuery = useIspUsage();

  if (themeSettings.isReady && themeSettings.enableIspStrip === false) {
...
export function Home() {
  ...
  const isIspView = searchParams.get("view") === "isp";
